...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-)r76mxjd$rt_2kpwx7s(p+j)39$(@vc#p#y3cj)_a$!_2^(7qd')
...
CSRF_TRUSTED_ORIGINS = ['https://harebrainedly-headmasterly-pete.ngrok-free.dev']
